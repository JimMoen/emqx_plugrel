...
validate_avsc(F) ->
    ...
    dbg:tracer(),
    dbg:p(all, c),
    dbg:tpl(avro_json_decoder, decode_value, cx),
    dbg:tpl(avro_json_decoder, decode_json, cx),
    dbg:tpl(avro_json_decoder, parse, cx),
    dbg:tpl(avro_json_decoder, parse_union, cx),
    try
        begin
